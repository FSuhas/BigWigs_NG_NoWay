...
L:RegisterTranslations("enUS", function() return {
	...
	barStartRandomBeams = "Début des Rayons verts!",

	eye_beam_trigger = "Tentacule oculaire géant se prépare à lancer Rayon de l'Oeil.",
	eye_beam_trigger_cthun = "Œil de C'Thun se prépare à lancer Rayon de l'Oeil.",
	eyebeam		= "Rayon de l'Oeil sur %s",
	Unknown = "Inconnu", -- Eye Beam on Unknown
...
L:RegisterTranslations("frFR", function() return {
	...
	--tentacle_cmd = "tentacle",
	tentacle_name = "Alerte des Tentacules",
	tentacle_desc = "Avertit de l'arrivée des Tentacules",
	--rape_cmd = "rape",
	rape_name = "Rape jokes are funny",
	rape_desc = "Some people like hentai jokes.",
	tentacle	= "Tentacules occulaire dans 5 secondes",
	norape		= "Tentacules oculaire dans 5 secondes!",
	barTentacle	= "Tentacules oculaire!",
	barNoRape	= "Tentacules oculaire!",

	--glare_cmd = "glare",
	glare_name = "Alerte de Sombre regard",
	glare_desc = "Avertit pour le Sombre regard",
	glare		= "Sombre regard!",
	msgGlareEnds	= "Sombre regard se termine dans 5 sec",
	barGlare	= "Prochain Sombre Regard!",
	barGlareEnds = "Fin du Sombre Regard",
	barGlareCasting = "lancement Sombre Regard",

	--group_cmd = "group",
	group_name = "Alerte de Sombre regard sur le groupe",
	group_desc = "Avertit quand le Sombre regard est sur le groupe X",

	phase2starting	= "L'oeil est mort! Le corps arrive!",

	playersInStomach = "Joueurs dans l'estomac",

	--giant_cmd = "giant",
	giant_name = "Alerte de Tentacule oculaire géant",
	giant_desc = "Avertit de l'arrivée des Tentacule oculaire géant",
	barGiant	= "Tentacule oculaire géant!",
	barGiantC	= "Tentacule griffu géant!",
	GiantEye = "Tentacule oculaire géant dans 5 secundes!",
	gedownwarn	= "Tentacule oculaire géant down!",

	--weakened_cmd = "weakened",
	weakened_name = "Alerte de Vunérabilité",
	weakened_desc = "Avertit quand C'thun est vulnérable",
	weakenedtrigger = "est affaibli!",
	weakened	= "C'Thun est affaibli pour 45 sec",
	invulnerable2	= "Affaiblissement se termine dans 5 seconds",
	invulnerable1	= "Affaiblissement terminé - C'Thun est invulnerable",
	barWeakened	= "C'Thun est affaibli!",

	--acid_cmd = "acid",
	acid_name = "Alerte d'Acide digestif",
	acid_desc = "Avertit quand vous avez 5 stack d'Acide digestif",
	digestiveAcidTrigger = "êtes affecté par Acide digestif [%s%(]*([%d]*).",
	msgDigestiveAcid = "5 Stacks d'Acide",

	["Second TentacleHP"] = "Seconde Tentacule %d%%",
	["First Tentacle dead"] = "Première Tantacule est morte",
	["First Tentacle"] = "Primière Tentacule",
	["Second Tentacle"] = "Seconde Tentacule",
	...
	--proximity_cmd = "proximity",
	proximity_name = "Alerte de Proximité",
	proximity_desc = "Montre la fenêtre de Proximité",

	--stomach_cmd = "stomach",
	stomach_name = "Joueur dans l'estomac",
	stomach_desc = "Afficher les joueurs dans l'estomac au lieu de joueurs trop proches",
...
local timer = {
	...
	p2ETentacle = 50,     -- Eye tentacle timers for phase 2
