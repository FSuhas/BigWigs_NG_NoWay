...
L:RegisterTranslations("frFR", function() return {
	...
	--["minimap"] = "minimapa",
	["Minimap"] = "Minimap",
	["Toggle the minimap button."] = "Active ou désactive le bouton de la minimap",
	["All running modules have been reset."] = "Tous les modules actifs ont \195\169t\195\169 red\195\169marr\195\169s.",
	["All running modules have been rebooted for all raid members."] = "TTous les modules actifs ont été redémarrer pour l'enssemble du raid",
	["All running modules have been disabled."] = "Tous les modules ont \195\169t\195\169 d\195\169sactiv\195\169s.",
	["%s reset."] = "%s Reinitialisé",
	["%s disabled."] = "%s Desactivé",
	["%s icon is now %s."] = "L'icone %s est maintenant %s.",
	["Show it again with /bw plugin minimap."] = "Vous pouvez la réactiver en tapant /bw plugin minimap",
	["You need to be an assistant or raid leader to use this function."] = "Vous devez avoir une assist ou être chef de raid pour utiliser cette fonction",
} end)
